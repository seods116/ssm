							...
							<table class="table_style5">
								...
								<tbody>
									<tr>
										<th>체크박스</th>
										<td>
										<label><input type="checkbox" value="" name="" class="chk" checked="checked" /> 체크</label>
										<label><input type="checkbox" value="" name="" class="chk" /> 체크</label>
										<label><input type="checkbox" value="" name="" class="chk" /> 체크</label>
										</td>										
									</tr>
									<tr>
										<th>라디오버튼</th>
										<td>
										<label><input type="radio" value="" name="radio1" class="radio" /> 선택1</label>
										<label><input type="radio" value="" name="radio1" class="radio" /> 선택2</label>
										</td>										
									</tr>
									<tr>
										<th>셀렉트박스</th>
										...
										<select>
											...
											<option value="3" selected="selected">선택33333</option>
										</select>
										</td>										
									</tr>
									<tr>
										<th>입력폼</th>
										<td><input type="text" name="" value="" class="input_style1" /></td>										
									</tr>
									<tr>
										<th>내 용</th>
									...
									<tr>
										<th>내 용</th>
										<td><textarea name="">입력받은 내용을 표기 합니다. 
...
텍스트에어리어</textarea></td>										
							...
							<div class="btn_right_area">
								<input type="submit" value="작성하기"  class="btn_style2" />	
								<input type="button" value="취소" class="btn_style2" />									
							</div>
							</form>
							</div>
