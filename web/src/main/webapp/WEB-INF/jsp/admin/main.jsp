					...
					<nav>
						<ul>
							<li class="on">
								...
								<div class="dns">
									<ul class="dept2">
										<li class="on"><a href="#self">중메뉴1</a></li>									
			...
			<section id="container">
				...
				<div id="contents">
					<div class="main_contents_wrap">
						<ul class="partition_wrap">								
							<li class="box">
								<dl>
									<dt>
										<em class="mc_ico2"></em><strong>TODAY</strong> 견적문의
										<a href="#self" class="more"></a>

									</dt>
									<dd class="main_view_conts1">
										<strong class="grand_txt">10</strong>
										<span class="exp_txt">당일견적문의 <span class="num">8</span>건</span>
										<span class="exp_txt">누적견적문의 <span class="num">2</span>건</span>
									</dd>
								</dl>
							</li>
							<li class="box">
						...
						</ul><!-- end : class : partition_wrap -->
					</div><!-- end : class : main_contents_wrap -->					
				</div><!-- end : id : contents -->
